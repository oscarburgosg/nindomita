(function($) {
  ...
  $(window).on('load', function() {
    ...
    $('.anchor-proyecto').click(function () {
      $('html, body').animate({
          scrollTop: ($('#proyectos').offset().top) - 90
      }, 500);
    });

    $('.anchor-somos').click(function () {
      $('html, body').animate({
          scrollTop: ($('#quienesSomos').offset().top) - 90
      }, 500);
    });

    $('.anchor-interes').click(function () {
      $('html, body').animate({
          scrollTop: ($('#interes').offset().top) - 90
      }, 500);
    });
